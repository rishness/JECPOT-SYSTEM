                            ...
                            <div class="card">
                                ...
                                <div class="card-footer p-4">
                                    <form class="text-center" method="post">
                                        <div class="mb-3"><button class="btn btn-success d-block w-100" type="button" data-bs-target="#purchase" data-bs-toggle="modal">Purchase&nbsp;</button></div>
                                    </form>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card">
                            <div class="card-body text-center p-4">
                                ...
                                <div class="mb-3"><input class="form-control" type="number" name="amount" placeholder="Amount " required></div>
                                <input type="hidden" name="total_sales" value="<?php include 'functions/pos-total.php'; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer"><button class="btn btn-light" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-success" type="submit">Process</button></div>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="text-center" action="functions/pos-add-item.php" method="post">
                        ...
                        <div class="mb-3"><button class="btn btn-info d-block w-100" type="submit">Add Item</button></div>
                    </form>
                </div>
